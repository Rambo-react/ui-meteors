...
const SvgCalendarIconOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    ref={ref}
    viewBox={'0 0 24 24'}
    ...
    {...props}
  >
    <g clipPath={'url(#calendar-outline_svg__a)'} fill={props.fill}>
      <path
        d={
...
const ForwardRef = forwardRef(SvgCalendarIconOutline)
